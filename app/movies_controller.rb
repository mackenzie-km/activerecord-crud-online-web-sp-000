...
def can_be_created_in_a_block(args = {title: "Home Alone", release_date: 1990})
  #or can just do m.title = args[:title] and so on
  Movie.create do |m|
...
def can_find_the_first_item_from_the_database_using_id
  Movie.find_by id: 1
  #or can put parenthesis around the id: 1
end

def can_find_by_multiple_attributes
  Movie.find_by title: "Title", release_date: 2000, director: "Me"
  #can also put parenthesis around everything
end
...
def can_be_found_updated_and_saved
  ...
  found = Movie.create(title: "Awesome Flick")
  Movie.update(found.id, :title => "Even Awesomer Flick")
  Movie.save
end
